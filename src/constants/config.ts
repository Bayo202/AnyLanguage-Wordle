export const CONFIG = {
  ...
  language: 'Eré-Ọ̀rọ̀ Yorùbá (ẹ̀yà bẹ́tà láìsí àmì ohùn)', // This changes the display name for your language
  wordLength: 5, // This sets how long each word is based on how many characters (as defined in orthography.ts) are in each word
  author: 'Báyọ̀', // Put your name here so people know who made this Wordle!
  authorWebsite: 'https://github.com/gbakinroa/Yoruba-Wordle', // Put a link to your website or social media here
